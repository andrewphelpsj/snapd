...
// ClusterSubcluster holds the details about a subcluster in a cluster assertion.
...
// Cluster holds a cluster assertion, which describes a cluster of devices
// and their organization into subclusters.
type Cluster struct {
	assertionBase
	seq         int
