...
func (s *interfaceManagerSuite) mockAppSetWithExtraPlug(c *C, yamlText string, plug *snap.PlugInfo) *interfaces.SnapAppSet {
	set := s.mockAppSet(c, yamlText)
	plug.Snap = set.Info()
	set.Info().Plugs[plug.Name] = plug
	return set
}
