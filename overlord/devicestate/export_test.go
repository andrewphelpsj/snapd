...
func MockSnapstateDownload(f func(ctx context.Context, st *state.State, name string, blobDirectory string, components []string, revOpts snapstate.RevisionOptions, opts snapstate.Options) (*state.TaskSet, *snap.Info, error)) (restore func()) {
